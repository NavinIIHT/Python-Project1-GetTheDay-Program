    ...
    def test_is_array(self):
        ...
        if type(obj)==type([]):
            with open("output_revised.txt","a") as f:
                ...
                print("{}TestIsArray = {}Passed".format(Fore.YELLOW,Fore.GREEN))

        else:
            with open("output_revised.txt","a") as f:
                f.write("TestIsArray=False\n")
                print("{}TestIsArray = {}Failed".format(Fore.YELLOW,Fore.RED))
    ...
    def test_is_str(self):
        ...
        if type(obj)==type(" "):
            with open("output_revised.txt","a") as f:
                ...
                print("{}TestIsString = {}Passed".format(Fore.YELLOW,Fore.GREEN))
        else:
            with open("output_revised.txt","a") as f:
                f.write("TestIsString=False\n")
                print("{}TestIsString = {}Failed".format(Fore.YELLOW,Fore.RED))
